...
BukiLauncher'da mod kurmak için; indirdiğiniz modu kopyalayın, ardından "Minecraft Klasörünü Göster" düğmesine tıklayın ve açılan pencereden `mods` klasörüne girin. Kopyaladığınız modu yapştırın.

Modlarınızı bu klasörde yönetebilirsiniz.
...
# BukiLauncher - EN
BukiLauncher is a simple and fast Minecraft launcher.
With BukiLauncher, you can download and play any Vanilla, Snapshot, and Fabric versions you want.
...
# BukiLauncher - DE
BukiLauncher ist ein einfacher und schneller Minecraft-Launcher.
Mit BukiLauncher kannst du alle gewünschten Vanilla-, Snapshot- und Fabric-Versionen herunterladen und spielen.
